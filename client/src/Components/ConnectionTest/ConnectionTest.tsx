...
const reqMessage = {
  ...
  [reqState.SUCCESS]: <><i className="fa fa-check"></i> Client successfully connected to the CBR Manager API.</>,
  [reqState.ERROR]: <><i className="fa fa-exclamation-triangle"></i> Failed to connect to the CBR Manager API.</>,
}
...
const ConnectionTest = () => {
  ...
  return (
    <div>
      ...
      <Alert variant={reqAlertClass[reqStatus]}>
        {reqMessage[reqStatus]}
      </Alert>
    </div>
  );
}
