...
# Ask which folder
echo "Choose which backup type (floder) you want to restore from."
echo "(ignore the PRE)"
...
echo "Backup successfully downloaded (~/$selected_backup)."
echo
...
eoho "4. If DB being restored and current DB have different POSTGRES_USER, then:"
