...
class RiskType(models.TextChoices):
    ...
    def getField():
        return models.CharField(max_length=6, choices=RiskType.choices, default='HEALTH')
...
class Client(models.Model):
    ...
    phone_number = models.CharField(max_length=50, blank=True) # if contact info available
    ...
    caregiver_phone = models.CharField(max_length=50, blank=True) # if caregiver present
    caregiver_email = models.CharField(max_length=50, blank=True) # if caregiver present
