...
urlpatterns = [
    ...
    path("patient-notes/<str:client_id>/", views.NoteList.as_view(), name="patient-notes-for-client"),    
    path("patient-notes/", views.NoteCreate.as_view(), name="create-patient-note"),    
    path("patient-notes/latest/<str:client_id>/", views.LatestPatientNote.as_view(), name="latest-patient-note"),
]
